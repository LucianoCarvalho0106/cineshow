import {MovieSilgleContent,ContentAll,DivImgFilme,Title,Avaliacao,Sinopse,Right,ButtonTrailer} from "./MovieSingleSeriesPopulares.style"
...
const MovieSingleSeriesPopulares = () => {
...
export default MovieSingleSeriesPopulares